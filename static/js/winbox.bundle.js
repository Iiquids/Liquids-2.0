 ...
 */
 (function() {
    ...
    function m(a, b, c, g) { a.addEventListener(b, c, g || !1 === g ? g : !0) }
    ...
    S["new"] = function(a) { return new S(a) };
    ...
    function fa(a) {
        ...
        m(a.g, "click", function() { a.focus() }, !1)
    }
    ...
    function V() { for (var a = w.length, b = 0, c, g; b < a; b++) c = w[b], g = Math.min((P - 2 * c.left) / a, 250), c.resize(g + 1 | 0, 35, !0).move(c.left + b * g | 0, Q - c.bottom - 35, !0) }
    ...
    function W(a, b) {
        ...
        function g(d) {
            ...
            if ("title" === b) {
                ...
                if ("s" === b || "se" === b || "sw" === b) { a.height += q; var r = 1 } else if ("n" === b || "ne" === b || "nw" === b) a.y += q, a.height -= q, v = r = 1
            }
    ...
    e.setBackground = function(a) { t(this.g, "background", a); return this };
    e.setUrl = function(a) { this.body.innerHTML = '<iframe src="' + a + '"></iframe>'; return this };
    e.focus = function() { H !== this && (t(this.g, "z-index", D++), this.addClass("focus"), H && (H.removeClass("focus"), H.i && H.i()), H = this, this.l && this.l()); return this };
    e.hide = function() { return this.addClass("hide") };
    e.show = function() { return this.removeClass("hide") };
    ...
    e.maximize = function(a) { if ("undefined" === typeof a || a !== this.max) this.min && X(this), (this.max = !this.max) ? this.addClass("max").resize(P - this.left - this.right, Q - this.top - this.bottom, !0).move(this.left, this.top, !0) : this.resize().move().removeClass("max"); return this };
    e.fullscreen = function(a) { if ("undefined" === typeof a || a !== E) this.min && (this.resize().move(), X(this)), E && Y() || (this.body[I](), E = !0); return this };

    function Y() { E = !1; if (document.fullscreen || document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement) return document[N](), !0 }
    e.close = function(a) {
